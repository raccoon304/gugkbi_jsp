...
// insert update delete ===> DML ===> POST 방식으로 전송
	// 아니면 임의로 url 조작을 통해서 헤집어놓을 수 있음. 
// select ===> GET 
	// 단, 민감한 데이터를 조회하는 경우(개인정보 등) POST를 사용하는게 옳다. 
...
//		HttpServletRequest req 객체는 전송되어온 데이터를 처리해주는 용도로 쓰인다.
		...
		out.println("<html>"
				...
				+ "</head>"
				+ "<body>"
				+ 	"<h2>개인성향 테스트 결과 01(POST)</h2>"
				+ 	"<span style='color:red; font-weight:bold;'>" + name + "</spna>님의 개인성향은<br><br>"
