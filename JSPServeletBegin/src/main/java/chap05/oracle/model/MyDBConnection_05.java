...
*/
	...
	static {
		...
		conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","JSPBEGIN_USER","sistsix");	
	...
	public static Connection getConn() {
		return conn;
	}// ==== EoP public static Connection getConn() ====
	...
	}// ==== EoP public static void closeConnection() ====
}
