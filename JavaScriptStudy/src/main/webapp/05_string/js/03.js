window.onload = function() {
   ...
   */
    ...
    /*
      2. "기존문자열" 의 대소문자를 구분치 않으려면 정규표현식을 사용하여 
      /i (대소문자 구분이 없는 insensitive) 를 사용하면 된다. 
   */
    new_str = str.replace(/MiCroSoFT/i , "마이크로소프트"); //      /와/ 사이에는 "또는 ' 없어야 한다.
    document.getElementById("replace_2").innerHTML = new_str;
    // --> Please visit 마이크로소프트! ORACLE / Microsoft MS-SQL 
    // 처음 나오는 Microsoft가 대소문자 관계없이 바뀜
   ...
   */
    new_str = str.replace(/MiCroSoFT/gi , "마이크로소프트"); //      /와/ 사이에는 "또는 ' 없어야 한다.
    document.getElementById("replace_3").innerHTML = new_str;
    // Please visit 마이크로소프트! ORACLE / 마이크로소프트 MS-SQL 
    // 모든 Microsoft가 대소문자 관계없이 바뀜
