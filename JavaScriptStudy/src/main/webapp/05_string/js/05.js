...
window.onload = function(){
  ...
  */
    ...
    */
    ...
    index = text2.search(/[가-힣]/);    // 최초로 한글이 나오는 위치를 찾아준다. 
    document.getElementById("search_2").innerHTML = index; // 0 
    ...
    */
    ...
    bool = text.endsWithith("문화원");
    document.getElementById("endsWith_1").innerHTML = bool;
    // true

    bool = text.endsWithsWith("문화투");
