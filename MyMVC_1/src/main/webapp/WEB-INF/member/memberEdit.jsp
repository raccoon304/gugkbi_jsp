	            	...
	            	<tbody>
		                ...
		                <tr>
		                    ...
		                    <td>
		                    	...
		                    	<input type="hidden" name="name" id="name" maxlength="30" class="requiredInfo" value="${sessionScope.loginUser.name}" />
		                ...
		                <tr>
		                    <td colspan="2" class="text-center" style="padding: 30px 0 10px 0">
		                       	<input type="button" class="btn btn-success btn-lg mr-5" value="수정하기" onclick="goEdit()" />
		                       	<input type="reset"  class="btn btn-danger btn-lg" value="취소하기" onclick="self.close()" />
		                    </td>
		                </tr>
	             	</tbody>
	             </table>
